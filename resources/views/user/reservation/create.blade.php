    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex m-2 p-2">
                <a href="{{ route('user.reservations.index', ['restaurant' => $restaurant_id]) }}" class="px-4 py-2 bg-purple-400 hover:bg-purple-700 rounded-lg text-white">My Reservations</a>
            </div>
